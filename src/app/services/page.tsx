    ...
    <div className="bg-black min-h-screen">
      ...
      >
        ...
        <div className="mt-4 overflow-visible">
          <h1 className="font-display text-[16vw] md:text-[11vw] leading-none text-white">
        ...
        >
          <div className="grid md:grid-cols-[1fr_2fr] gap-10 md:gap-20 items-start">
            ...
            <div className="reveal-item flex md:justify-end">
              <div>
                <span className="font-display text-[18vw] md:text-[8vw] text-white/5 leading-none block">
                  {service.num}
                </span>
              </div>
            </div>
            ...
            <div>
              <div className="reveal-item">
                <div className="text-accent text-[10px] tracking-[0.25em] uppercase font-semibold mb-3">
                  {service.subtitle}
                </div>
              </div>

              <div className="reveal-item overflow-hidden">
                <h2 className="font-display text-[8vw] md:text-[5vw] leading-none text-white mb-6">
              ...
              <div className="reveal-item flex flex-wrap gap-2 mt-6">
                {service.tags.map((tag) => (
                  <span
                    key={tag}
                    className="text-[9px] tracking-[0.15em] uppercase text-white/30 border border-white/10 px-3 py-1.5"
                  >
                    {tag}
                  </span>
                ))}
              ...
              {service.num === '03' && (
                <div className="reveal-item mt-6">
                  <Link
                    ...
                    className="inline-flex items-center gap-2 text-accent text-xs tracking-[0.15em] uppercase font-semibold border-b border-accent/40 pb-0.5 hover:border-accent transition-colors duration-300"
                  >
      ...
      {/* CTA */}
      <section className="px-6 md:px-10 max-w-[1400px] mx-auto py-20 md:py-32 border-t border-white/5 text-center">
        <h2 className="font-display text-[12vw] md:text-[7vw] text-white leading-none">
          READY TO START?
        </h2>
