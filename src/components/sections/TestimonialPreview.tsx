    ...
    <section ref={sectionRef} className="bg-cream py-20 md:py-32 overflow-hidden">
      <div className="max-w-[1400px] mx-auto px-6 md:px-10">
        ...
        <div ref={quoteRef} className="mt-12 relative">
          {/* Large quote mark */}
          <div
            className="absolute -top-10 -left-4 md:-left-8 font-display text-[20vw] text-espresso/3 leading-none select-none pointer-events-none"
            aria-hidden="true"
          >
            "
          </div>
          ...
          <blockquote className="relative z-10 max-w-4xl">
            <p className="font-display text-[5vw] md:text-[3vw] text-espresso leading-[1.2] italic">
            ...
            <footer className="mt-8 flex items-center gap-4">
              ...
              <div>
                <cite className="not-italic text-xs tracking-[0.2em] uppercase text-espresso/50 font-semibold">
        ...
        <div className="mt-10 flex justify-end">
          <a
            href="/testimonials"
            className="text-espresso/30 hover:text-terracotta text-xs tracking-[0.2em] uppercase font-semibold transition-colors duration-300 inline-flex items-center gap-2"
          >
            Read More
