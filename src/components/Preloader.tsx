...
export function Preloader({ onComplete }: { onComplete: () => void }) {
  ...
  return (
    ...
    >
      ...
      <div
        ref={streakRef}
        className="absolute left-0 right-0 top-1/2 -translate-y-1/2 h-px bg-terracotta z-10"
        style={{ transform: 'scaleX(0) translateY(-50%)' }}
      />

      {/* Main text */}
      <div className="flex flex-col items-center gap-6">
        <div ref={textRef} className="font-display text-[10vw] md:text-[7vw] text-espresso tracking-wider flex gap-0">
        ...
        <div className="text-espresso/40 text-xs tracking-[0.3em] uppercase">
      ...
      <div
        ref={counterRef}
        className="absolute bottom-8 right-10 font-display text-[8vw] text-espresso/10 leading-none tabular-nums"
      >
