...
const socialLinks = [
  { label: 'TikTok', href: 'https://www.tiktok.com/@e.o.creative' },
  { label: 'Instagram', href: 'https://www.instagram.com/youthmama_mentors' },
  { label: 'X / Twitter', href: 'https://x.com/pr_nurse' },
  { label: 'LinkedIn', href: 'https://www.linkedin.com/in/esther-ozurumba-575706248' },
]
